...
MODEL_NAME_NET_CLASS_MAP = {
    'ConvTemporalConvNet': framenets.ConvTCN,
    'MultiStackTemporalConvNet': framenets.MultiStackTCN,
    'SkipTemporalConvNet': framenets.SkipTCN,
    'TemporalConvNet': framenets.TCN,
    'TweetyNet': vak.nets.TweetyNet,
}

LOSS_NAME_CLASS_MAP = {
    "ce": torch.nn.CrossEntropyLoss,
    "ce-tmse": framenets.loss.CrossEntropyWithTruncatedMSE,
    "ce-gstmse": framenets.loss.CrossEntropyWithGaussianSimilarityTruncatedMSE,
}
...
def main(toml_path):
    ...
    framenets.learncurve.learning_curve(
