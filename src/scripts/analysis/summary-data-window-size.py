#!/usr/bin/env python
# coding: utf-8
"""Script that generates summary data for window size experiments"""
...
COLUMNS = [
    'model_name', 'dataset', 'train_dur', 'replicate_num', 'window_size',
...
data.to_csv('results/summary-data-window-size-experiments.csv', index=False)
